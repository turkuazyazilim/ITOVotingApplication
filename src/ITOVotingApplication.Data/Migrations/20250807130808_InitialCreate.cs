    ...
    public partial class InitialCreate : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    CompanyTypeCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    CompanyTypeDescription = table.Column<string>(type: "nvarchar(100)", maxLength: 100, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_cdCompanyTypes", x => x.CompanyTypeCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    NaceCode = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    NaceDescription = table.Column<string>(type: "nvarchar(250)", maxLength: 250, nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_cdNaceCodes", x => x.NaceCode);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyType = table.Column<string>(type: "nvarchar(10)", maxLength: 10, nullable: false),
                    ...
                    MemberRegistrationDate = table.Column<DateTime>(type: "datetime2", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_cdCompany_cdCompanyTypes_CompanyType",
                        column: x => x.CompanyType,
                        principalTable: "cdCompanyTypes",
                        principalColumn: "CompanyTypeCode",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_cdCompany_cdNaceCodes_NaceCode",
                        column: x => x.NaceCode,
                        principalTable: "cdNaceCodes",
                        principalColumn: "NaceCode",
                        onDelete: ReferentialAction.Cascade);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_cdCompany_CompanyType",
                table: "cdCompany",
                column: "CompanyType");

            migrationBuilder.CreateIndex(
                name: "IX_cdCompany_NaceCode",
                table: "cdCompany",
                column: "NaceCode");
